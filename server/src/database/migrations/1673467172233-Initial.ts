...
export class Initial1673467172233 implements MigrationInterface {
    name = 'Initial1673467172233'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`project\` (\`created_date\` varchar(255) NOT NULL, \`modified_date\` varchar(255) NOT NULL, \`id\` varchar(36) NOT NULL, \`key\` varchar(255) NOT NULL, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NULL, \`workspace_id\` varchar(255) NOT NULL, \`owner_id\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`workspace_group\` (\`created_date\` varchar(255) NOT NULL, \`modified_date\` varchar(255) NOT NULL, \`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`key\` varchar(255) NOT NULL, \`workspace_id\` varchar(255) NOT NULL, \`default_permission\` enum ('read', 'write', 'admin') NOT NULL, \`description\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
